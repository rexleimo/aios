...
const cli = createCliParser({
  ...
  options: [
    ['--agent <name>', 'Agent name: codex-cli | claude-code | gemini-cli | opencode-cli | hermes-agent'],
    ...
    ['--team-provider <name>', 'Team provider: auto|codex|claude|gemini|opencode (default: auto)'],
    ['--team-workers <n>', 'Team workers count (default: 3)'],
    ['--harness-provider <name>', 'Harness provider: codex|claude|gemini|opencode|hermes (default: inferred)'],
