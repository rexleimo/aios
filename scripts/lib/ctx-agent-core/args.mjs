...
const cli = createCliParser({
  ...
  options: [
    ['--agent <name>', 'Agent name: codex-cli | claude-code | gemini-cli | opencode-cli | hermes-agent | grok-build'],
    ...
    ['--harness-provider <name>', 'Harness provider: codex|claude|gemini|opencode|hermes|grok (default: inferred)'],
