export const LIFECYCLE_COMMAND_SPECS = [
  ...
  },
  {
    ...
    options: [
      ...
      ['--project-root <path>', 'Project root for project-scoped skill installs (default: current directory)'],
  ...
  },
  {
    ...
    options: [
      ...
      ['--project-root <path>', 'Project root for project-scoped skill removals (default: current directory)'],
      ['--skills <list>', 'Comma list of skill names'],
    ],
  },
];
