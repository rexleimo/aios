...
/** Prepend a temp bin dir with fake provider CLIs so harness readiness does not depend on host installs. */
async function withFakeProviderPath(providerNames, fn) {
