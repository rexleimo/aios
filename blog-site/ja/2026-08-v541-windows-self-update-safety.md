...
description: "v5.4.1 は Windows 限定の自己更新失敗を修正しました。インストールツリー内から「aios update」を実行すると、インストーラーが削除すべきディレクトリがロックされ、新バージョンが静かにネストされ、後続の更新が MODULE_NOT_FOUND でクラッシュしていました。"
date: 2026-08-02
...
[変更履歴](https://cli.rexai.top/ja/changelog/)に v5.4.1 が記載されています。修正自体はリリース資産に含まれており、5.4.1 に上げれば更新は安全です。
