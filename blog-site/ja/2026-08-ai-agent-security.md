...
description: "Codex Security スレッドが今週最大の話題になりましたが、アドバイスの多くはプロンプトインジェクションに偏っていました。エージェントの安全性は主に状態機械の問題です：アクティベーション状態、並行するトークン前進、証拠の真正性。ワークフローレイヤーが何をできるかを解説します。"
date: 2026-08-02
