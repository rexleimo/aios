...
description: "AIOS v1.52.0 introduces aios_shell — an MCP tool that gives every AIOS client deterministic shell output compression at 99% saving, plus command guards."
date: 2026-06-11
