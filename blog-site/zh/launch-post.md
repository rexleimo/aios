---
title: "终于等到了！我做了 AIOS，让 AI 编程工具不再互相“打架”"
description: "AIOS 的诞生故事：一个统一 Claude Code、Codex 与 Gemini 的工作流层，不替换你已有的工具，只补上记忆、路由与验证。文章说明关键设计取舍、早期失败尝试，以及最终让它成立的那个决定。文中也给出当时的失败尝试与最终奏效做法的对照。"
---
