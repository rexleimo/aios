...
description: "一个调度层，能读懂你的任务描述并自动选择最合适的 AI 模型，再也不用死记硬背各家模型特长。文章解释路由依据、回退规则与 explain 参数的用法，也说明什么情况下应该手动覆盖自动选择。让你把精力放回问题本身，而不是反复纠结模型选型与配额。"
date: 2026-05-08
...
*Model Router 是 [AIOS](https://cli.rexai.top) 的一部分。查看[完整文档](https://cli.rexai.top/zh/model-router/)了解所有模型、规则和配置选项。*

## 相关文档

- [模型路由](https://cli.rexai.top/zh/model-router/)
