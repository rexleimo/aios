...
description: "AIOS가 Hermes Agent (Nous Research)를 최상위 클라이언트로 등록했습니다. MCP 브리지 서버가 context-pack, doctor, token compression 등 5개 코어 도구를 Hermes 세션 안에서 바로 쓸 수 있게 합니다."
date: 2026-06-30
