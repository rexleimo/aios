...
description: "Harness CLI가 xAI Grok Build를 skills/agents/native/team/harness 지원 1급 AIOS 클라이언트로 등록합니다. runtime id는 grok-build입니다."
date: 2026-07-09
...
xAI **Grok Build**(`grok` CLI)가 Codex CLI, Claude Code, Gemini CLI, OpenCode, Hermes Agent와 함께 Harness CLI의 1급 AIOS 클라이언트로 등록되었습니다.
