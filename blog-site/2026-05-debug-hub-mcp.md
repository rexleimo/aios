...
debug-hub is part of RexCLI's **observability layer**. It works alongside:
...
*debug-hub is at v0.3.0 and is part of [RexCLI](https://cli.rexai.top). Try it and give your agents the power of self-reflection.*
