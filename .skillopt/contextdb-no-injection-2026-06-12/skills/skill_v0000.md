...
- To resume, the user must explicitly name the task/handoff to continue.
...
Use `context:pack` only for explicit inspection/debug export. Do not feed the report into a model prompt by default.
