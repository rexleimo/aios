---
title: 高度デザインスキル
description: "「この部分をおしゃれにして」といった曖昧な依頼を、そのまま公開できるページに着地させるワークフローです。DESIGN.md で配色・文字サイズ・余白のビジュアル契約を固定し、frontend-design スキルでレイアウト、状態、レスポンシブの細部を埋めます。"
---
