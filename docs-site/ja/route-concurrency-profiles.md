...
description: "ルーティングと並列度を一ページで把握できます。最小限の環境変数で interactive routing、subagent、team、harness の並列レベルを切り替えられる、コピー可能な設定例、各項目の既定値、向いているタスク規模をまとめています。マシン負荷に応じてすぐ切り替えられます。"
---
