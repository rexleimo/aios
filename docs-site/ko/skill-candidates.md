...
description: "실패한 세션을 스킬 개선 패치로 바꾸는 방법을 설명합니다. 후보가 어떻게 감지되고 어떻게 검토하며 어떻게 안전하게 적용하고 되돌리는지 이해하면 에이전트의 실패를 쌓아 올릴 수 있는 개선으로 바꿀 수 있습니다. 검토와 검증을 통과한 후보만 정식 스킬에 들어갑니다."
---
