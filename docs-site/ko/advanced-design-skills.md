---
title: 고급 디자인 스킬
description: "「이 부분 좀 예쁘게 다듬어줘」 같은 모호한 요청을 실제 배포 가능한 페이지로 마무리하는 워크플로입니다. 먼저 DESIGN.md로 색상, 글자 크기, 여백 같은 비주얼 계약을 고정하고, frontend-design 스킬로 레이아웃과 상태, 반응형 세부를 채웁니다."
---
...
- [Rex 워크플로 마이그레이션](superpowers.md)
