---
title: HUD 사용자 가이드
description: "HUD(Heads-Up Display) 완전 가이드입니다. 실행 중인 에이전트 세션 상태, 장시간 작업 진행률, 품질 게이트 결과, 디스패치 결과, 스킬 개선 후보를 실시간으로 확인할 수 있습니다. 실행을 멈추지 않고 볼 수 있어 장시간 무인 실행과 사후 리뷰에 모두 적합합니다."
---
...
**출력 위치**: `.aios/context-db/sessions/<session-id>/artifacts/skill-candidate-patch-template-<timestamp>.md`
